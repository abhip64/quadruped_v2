...
The project runs in concurrence with an effort to develop a hardware prototype of a legged wall climbing robot. The purpose of the simualtion id
...
Currently 
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTI0NzI4NjE3M119
-->